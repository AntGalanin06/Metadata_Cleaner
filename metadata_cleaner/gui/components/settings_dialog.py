...
class SettingsDialog(ft.UserControl):
    ...
    def _build_metadata_tab(self, file_type: str) -> ft.Container:
        ...
        file_type_settings = self.current_settings.get("file_type_settings", {})
        settings: dict[str, bool] = file_type_settings.get(file_type, {})
    ...
    def _on_metadata_switch_change(self, e, file_type: str, field_key: str):
        ...
        file_type_settings = self.current_settings.get("file_type_settings", {})
        if file_type not in file_type_settings:
            file_type_settings[file_type] = {}
        file_type_settings[file_type][field_key] = e.control.value
    ...
    def _toggle_all_metadata(self, file_type: str, select_all: bool):
        ...
        for field in metadata_fields:
            file_type_settings[file_type][field.key] = select_all
...
Last Updated: June 25, 2025"""
    ...
    def _show_document_dialog(self, title: str, content: str):
        ...
        doc_dialog: ft.AlertDialog = ft.AlertDialog(
            modal=True,
            title=ft.Row(
                [
