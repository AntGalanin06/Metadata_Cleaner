...
Примеры использования:
  ...
  python scripts/run_tests.py --ci               # Режим для CI/CD
    ...
    test_group.add_argument("--integration", action="store_true", help="Только интеграционные тесты")
    test_group.add_argument("--performance", action="store_true", help="Тесты производительности")
    test_group.add_argument("--quick", action="store_true", help="Быстрые тесты (без медленных)")
    ...
    # Покрытие кода
    if not args.no_cov and (args.coverage or args.html or args.xml or args.json or args.ci):
        cmd.extend([
