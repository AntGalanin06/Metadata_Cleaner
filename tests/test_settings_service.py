...
class TestSettingsService(unittest.TestCase):
    ...
    @mock.patch(
        "metadata_cleaner.services.settings_service.SettingsService._get_settings_file_path"
    )
            ...
            with self.subTest(file_type=file_type):
                ...
                for key, value in current_settings.items():
                    self.assertIsInstance(
                        value, bool, f"Setting {key} should be boolean"
                    )
    ...
    def test_settings_persistence(self, mock_path):
        ...
        service1.update_file_type_settings(
            "image", {"exif_author": False, "gps_coords": True}
        )
            ...
            with self.subTest(file_type=file_type):
                ...
                for field in fields:
                    ...
                    if not field_exists:
                        ...
                        print(
                            f"Available fields for {file_type}: {list(metadata.keys())}"
                        )
